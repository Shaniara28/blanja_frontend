        ...
        <div className="login p-2">
          <div className="form-login">
            ...
            <form className="mt-5">
              ...
              <div className="mb-3">
                <input type="number" className={`${style.formControl} form-control`} id="phone" aria-describedby="phoneHelp" placeholder="  Phone" />
              </div>
              <div className="mb-3">
                <input type="text" className={`${style.formControl} form-control`} id="store" aria-describedby="storeHelp" placeholder="  Store" />
              </div>
              <div className="mb-3">
